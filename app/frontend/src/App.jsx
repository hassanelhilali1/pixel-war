...
// grille vide, tout en blanc au debut
function emptyGrid() {
  const g = {};
...
export default function App() {
  ...
  // on charge la grille depuis le backend au demarrage
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    // quand on recoit un pixel update d'un autre joueur
